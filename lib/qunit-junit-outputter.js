...
(function() {
	...
	/**
	 * Gets a system error XML doc.  Used if there was a major system error.
	 * @param {String} msg the error message to write
	 */
	cJUnitOutputter.prototype.getSystemError = function(msg) {
